...
이 폰트 소프트웨어는 SIL 오픈 폰트 라이선스 1.1에 따라 사용이 허가됩니다. 이 라이선스는 아래에 복사되어 있으며, <https://openfontlicense.org>에서 FAQ와 함께 확인할 수 있습니다.
...
2. 폰트 소프트웨어의 원본 또는 수정된 버전은 각 사본에 위의 저작권 고지 및 이 라이선스가 포함되어 있는 경우 모든 소프트웨어와 함께 번들·재배포·판매될 수 있습니다. 이들은 독립 실행형 텍스트 파일 또는 사람이 읽을 수 있는 헤더 또는 텍스트 및 이진 파일 내의 기계가 읽을 수 있는 적절한 메타데이터 필드에 포함될 수 있습니다.
